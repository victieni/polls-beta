...
export const InputOTP = withUniwind(
	forwardRef<InputOTPRef, InputOTPProps>(
		(
			{
				length = 6,
				value = "",
...
export const InputOTPWithSeparator = withUniwind(
	forwardRef<InputOTPRef, Omit<InputOTPProps, "separator">>((props, ref) => (
		<InputOTP
			ref={ref}
			separator={
